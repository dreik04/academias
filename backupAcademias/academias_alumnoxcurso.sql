...
CREATE TABLE `alumnoxcurso` (
  ...
  CONSTRAINT `alumno_curso_fk` FOREIGN KEY (`alumno_id`) REFERENCES `alumnos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `curso_alumno_fk` FOREIGN KEY (`curso_id`) REFERENCES `cursos` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `alumnoxcurso` VALUES (1,6,3);
